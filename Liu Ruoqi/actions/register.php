...
if (!preg_match('/^[A-Za-z0-9\s]+$/', $address)) {
    redirect_with('../register.php', 'error', 'Address can contain letters, numbers, and spaces only.');
}
...
redirect_with('../register.php', 'success', 'Seller registration saved successfully.');
